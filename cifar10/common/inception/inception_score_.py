'''
Compatibale with tensorflow 1.6+ with arbitrary batch size
Solves some other isssues also: https://github.com/openai/improved-gan/issues/29
...
BATCH_SIZE=128 # 64 220s, 128 207s
...
def get_inception_score(images, splits=10):
    ...
    logging.info('Inception Score for {} samples in {} splits'.format(preds.shape[0], splits))
    mean,std = preds2score(preds,splits)
    logging.info('Inception Score calculation time: {:.2f} s'.format(time.time()-start_time))
